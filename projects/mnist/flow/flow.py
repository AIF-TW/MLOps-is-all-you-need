...
def fetch_dataset(cfg):
    ...
    client.fget_object('dvc', cfg['dataset']['dot_dvc_path'], './MNIST.dvc',)
...
def preprocessing(root=f'./MNIST/train', shuffle_data=True, batch_size=64, random_seed=1, val_size=0.2):
